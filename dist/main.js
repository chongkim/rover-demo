...
/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
/*! exports provided: CELL_WIDTH, CELL_HEIGHT, LEFT, RIGHT, MOVE, DEG, BORDER_THICKNESS */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BORDER_THICKNESS", function() { return BORDER_THICKNESS; });
const CELL_WIDTH = 50;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.css */ "./src/main.css");
...
function enqueueJobs(content) {
    ...
    while (0 < lines.length) {
        ...
        jobs.push({
            ...
            deg: _constants__WEBPACK_IMPORTED_MODULE_1__["DEG"][orientation],
            started: false,
        });
    }
    processJob();
...
function calcX(x, width) {
    return x * (_constants__WEBPACK_IMPORTED_MODULE_1__["CELL_WIDTH"] + _constants__WEBPACK_IMPORTED_MODULE_1__["BORDER_THICKNESS"]*2) + 10;
}

function calcY(y, height) {
    return (height - y - 1) * (_constants__WEBPACK_IMPORTED_MODULE_1__["CELL_HEIGHT"] + _constants__WEBPACK_IMPORTED_MODULE_1__["BORDER_THICKNESS"]*2) + 2;
}
...
function processJob() {
    ...
    switch(instruction) {
        case 'M':
            const move = _constants__WEBPACK_IMPORTED_MODULE_1__["MOVE"][job.orientation];
            job.x += move.x;
            job.y += move.y;
            moveRover(job);
            break;
        case 'L':
            job.orientation = _constants__WEBPACK_IMPORTED_MODULE_1__["LEFT"][job.orientation];
            rotateRover(job.deg, job.deg - 90);
            job.deg -= 90;
            break;
        case 'R':
            job.orientation = _constants__WEBPACK_IMPORTED_MODULE_1__["RIGHT"][job.orientation];
            rotateRover(job.deg, job.deg + 90);
            job.deg += 90;
            break;
    }
